      ...
      <div className="relative">
        ...
        >
          ...
          <div
            ...
            style={{
              background: "linear-gradient(135deg, rgba(0, 212, 255, 0.98) 0%, rgba(196, 181, 253, 0.98) 50%, rgba(255, 165, 216, 0.98) 100%)",
            }}
          />
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          >
            ...
            <span className="text-sm font-semibold" style={{ color: "#1A1D3D" }}>AI Voice Interviewer • Top HR Product of 2025</span>
          </motion.div>
          ...
          >
            Every candidate speaks directly to our AI interviewer. Real conversations. Natural voice. No waiting. No bias. Just opportunity—at scale, in 22+ languages, starting the moment they apply.
          </motion.p>
